...
int main()
{
   ...
   while((ch = fgetc(fp)) != EOF){
      ...
      usleep(1000);
        ...
        system ("powershell -c (New-Object Media.SoundPlayer \"\welcome.wav\"\).PlaySync();");
  ...
  system ("powershell -c (New-Object Media.SoundPlayer \"\Rob.wav\"\).PlaySync();");
  ...
  printf("Avg Turnaround Time = %f \n"  , turnaround_time *1/n);
        goto TurniningPoint;
         ...
         FILE *fc;
   fc = fopen("credit.txt", "r"); // read mode
   ...
   while((ch = fgetc(fc)) != EOF){
      ...
      usleep(1000);
        ...
        system ("powershell -c (New-Object Media.SoundPlayer \"\thank.wav\"\).PlaySync();");
fclose(fp);
fclose(fd);
fclose(fc);
    return 0;
